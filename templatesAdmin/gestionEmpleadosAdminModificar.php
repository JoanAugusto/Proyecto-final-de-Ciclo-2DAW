        ...
        <div class="col-md-8 col-lg-6">
          <div class="card shadow-lg rounded-4">
            <div class="card-header bg-primary text-white text-center rounded-top-4">
              <h3 class="mb-0">Modificar Empleado</h3>
            </div>
                    <?php
                     ...
                     error_reporting(0);
                        ...
                        $empleado=load_empleado($conn,$id_empleado);
                    ?>

     <div class="card-body">

                            <form action="guardarModificacionEmpleado.php" method="POST">
                <div class="mb-3">
                    <label for="id_empleado" class="form-label">ID Empleado</label>
                    <input type="text" class="form-control" id="id_empleado" name="id_empleado" value="<?php echo htmlspecialchars($empleado['id_empleado']); ?>" readonly>
                </div>

                <div class="mb-3">
                    <label for="contrasena_empleado" class="form-label">Contraseña</label>
                    <input type="password" class="form-control" id="contrasena_empleado" name="contrasena_empleado" value="<?php echo htmlspecialchars($empleado['contrasena_empleado']); ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="apellido_empleado" name="apellido_empleado" value="<?php echo $empleado['apellido_empleado']; ?>">
                </div>

                <div class="mb-3">
                    <label for="numero_telefono_empleado" class="form-label">Teléfono</label>
                    <input type="tel" class="form-control" id="numero_telefono_empleado" name="numero_telefono_empleado" value="<?php echo $empleado['numero_telefono_empleado']; ?>">
                </div>

                <div class="mb-3">
                    <label for="correo_empleado" class="form-label">Correo Electrónico</label>
                    <input type="email" class="form-control" id="correo_empleado" name="correo_empleado" value="<?php echo $empleado['correo_empleado']; ?>">
                </div>
                ...
                <div class="form-check form-switch mb-3">
                    ...
                    <?php echo ($empleado['es_admin']) ? 'checked' : ''; ?>>
