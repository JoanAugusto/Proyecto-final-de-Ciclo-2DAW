        ...
        <div class="col-md-8 col-lg-6">
          <div class="card shadow-lg rounded-4">
            <div class="card-header bg-primary text-white text-center rounded-top-4">
              <h3 class="mb-0">Modificar Menu</h3>
            </div>
                    <?php
                     ...
                     error_reporting(0);
                        ...
                        $menu=load_menu($conn,$id_categoria);
                    ?>

     <div class="card-body">

                            <form action="guardarModificacionMenu.php" method="POST">
                <div class="mb-3">
                    <label for="id_categoria" class="form-label">ID Menu</label>
                    <input type="text" class="form-control" id="id_categoria" name="id_categoria" value="<?php echo htmlspecialchars($menu['id_categoria']); ?>" readonly>
                </div>

                <div class="mb-3">
                    <label for="nombre_categoria" class="form-label">Nombre Categoria</label>
                    <input type="text" class="form-control" id="nombre_categoria" name="nombre_categoria" value="<?php echo htmlspecialchars($menu['nombre_categoria']); ?>">
                </div>
