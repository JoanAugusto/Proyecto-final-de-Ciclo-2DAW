<!-- NAVBAR -->
  ...
  <div class="offcanvas offcanvas-end offcanvas" tabindex="-1" id="offcanvas">
    ...
    <div class="offcanvas-body bg-light d-flex flex-column align-items-center">
      <a href="../templates/camareroVista.php" class="btn btn-primary w-75 mb-3 fs-5">Inicio</a>
      <a href="../templates/seccionMesasCamarero.php" class="btn btn-primary w-75 mb-3 fs-5">Sección de Mesas</a>
      <a href="../templates/seccionComandasCamarero.html" class="btn btn-primary w-75 mb-5 fs-5">Sección de Comandas</a>
